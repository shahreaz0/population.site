...
export const metadata: Metadata = {
  title: "Population by Continent 2026 - Global Demographics",
  description:
    "Explore population statistics by continent. View total headcount, land area ratios, average density, share of world population, and fastest growing continents.",
}
    ...
    <div className="container mx-auto flex flex-col gap-6 px-4 py-8">
      ...
      <div className="mx-auto flex max-w-3xl flex-col gap-2 text-center">
        ...
        <p className="text-muted-foreground text-sm leading-relaxed">
          Demographic overview and comparison of the world's six major inhabited
          continental regions.
        </p>
      </div>

      {/* AdSense Block */}
      <AdSenseBlock slot="continents-top" format="horizontal" />
      ...
      {/* AdSense Block */}
      <AdSenseBlock slot="continents-bottom" format="horizontal" />
    </div>
  )
}
